...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["application/pdf", "text/plain", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for knowledge-docs" ON storage.objects FOR SELECT USING (bucket_id = 'knowledge-docs');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for knowledge-docs" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'knowledge-docs');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for knowledge-docs" ON storage.objects FOR UPDATE USING (bucket_id = 'knowledge-docs');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for knowledge-docs" ON storage.objects FOR DELETE USING (bucket_id = 'knowledge-docs');`
    ];
